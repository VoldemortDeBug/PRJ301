...
public class MainController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action != null && action.equals("delete") && ((UserDTO)request.getSession().getAttribute("user")).getRoleID().equals("AD")) {
                url = "search.jsp";
                String bookID = request.getParameter("bookID");
                bdao.delete(bookID);
                searchResponse(request, response);
            }
            if (action != null && action.equals("add") && ((UserDTO)request.getSession().getAttribute("user")).getRoleID().equals("AD")) {
                url = "search.jsp";
