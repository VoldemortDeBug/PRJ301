<%-- 
    Document   : index.jsp
    Created on : Mar 13, 2025, 8:39:37 AM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        <%
            List<BookDTO> bookpage = new ArrayList<>();
            if (request.getAttribute("bookpage") != null) {
                bookpage = (List<BookDTO>) request.getAttribute("bookpage");
            }
        %>
